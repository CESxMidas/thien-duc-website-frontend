  ...
  return (
    ...
    >
      <div className="relative h-[clamp(32rem,75svh,51.25rem)]">
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-7 z-30 hidden justify-start px-6 pr-28 md:flex md:px-10 lg:px-16 xl:px-20">
