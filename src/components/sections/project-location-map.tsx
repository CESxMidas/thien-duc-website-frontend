    ...
    <section className="project-detail-band reveal-section overflow-hidden py-10">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid w-full gap-4 lg:grid-cols-2 lg:items-stretch">
          {aerialImage ? (
            <div
              className="image-reveal relative w-full overflow-hidden border border-[#B06613]/18 bg-[#f2f2f2] shadow-[0_16px_36px_rgba(127,75,13,0.1)]"
          ...
          <div
            className="image-reveal relative w-full overflow-hidden border border-[#B06613]/18 bg-[#0c5b3f] shadow-[0_16px_36px_rgba(127,75,13,0.12)]"
            style={{ aspectRatio: "1024 / 683" }}
          >
