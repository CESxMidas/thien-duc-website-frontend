...
export function HomeFacts({ locale }: { locale: Locale }) {
  ...
  return (
    <section className="border-y border-earth/25 bg-ivory text-charcoal">
      <div className="grid w-full px-5 py-6 sm:grid-cols-2 sm:px-8 lg:grid-cols-[1fr_1fr_1.25fr_1fr_0.9fr] lg:px-20 lg:py-7 xl:px-28">
        {facts.map((fact) => (
          <div
            key={fact.label}
            className="border-b border-earth/20 py-5 pr-5 sm:even:border-l sm:even:pl-8 lg:border-b-0 lg:border-r lg:px-8 lg:py-0 lg:first:pl-0 lg:even:border-l-0"
          >
        ...
        <div className="flex items-center pt-5 sm:col-span-2 lg:col-span-1 lg:border-l lg:border-earth/30 lg:pl-10 lg:pt-0">
